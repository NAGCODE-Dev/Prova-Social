...
class ResultPage extends StatelessWidget {
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                DecoratedBox(
                  ...
                  child: Padding(padding: const EdgeInsets.all(26), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    const Text('RESULTADO CONCLUÍDO', style: TextStyle(color: Color(0xFF9FB7FF), fontSize: 11, fontWeight: FontWeight.w900, letterSpacing: 1.2)),
                    ...
                    const Text('Use os erros abaixo como mapa para a próxima revisão.', style: TextStyle(color: Color(0xFFB7C0D2))),
                  ])),
                ),
                ...
                ...List.generate(result.exam.questions.length, (index) {
                  ...
                  return Padding(
                    ...
                    child: Card(child: Padding(padding: const EdgeInsets.all(16), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      if (!correct) Text('Gabarito: ${question.options[question.correctIndex]}', style: const TextStyle(color: AppColors.muted)),
                    ]))),
                  );
                }),
              ]),
  ...
  Future<void> _copyJson(BuildContext context) async {
    ...
    if (context.mounted) ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Resultado JSON copiado.')));
  }
